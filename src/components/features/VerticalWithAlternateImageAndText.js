...
const Image = styled.div((props) => [
  ...
  tw`rounded md:w-1/2 lg:w-5/12  flex-shrink-0 h-80 md:h-144 bg-cover bg-center mx-4 sm:mx-8 md:mx-4 lg:mx-8`,
]);
...
export default ({
  ...
  description = "Here are some of the most popular events in New York City curated by professionals.",
  cards = [
    {
      imageSrc:
          ...
          {cards.map((card, i) => (
            <Card key={i} reversed={i % 2 === 1}>
              ...
              <Details>
                ...
                <Link href={card.url}>{card.urlText}</Link>
              </Details>
            </Card>
          ))}
        </Content>
