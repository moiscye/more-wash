...
const TextInfo = tw.div`py-6 sm:px-10 sm:py-6 text-left`;
const TitleReviewContainer = tw.div`flex flex-col sm:flex-row sm:justify-between sm:items-center text-left`;
        ...
        <CardSlider ref={setSliderRef} {...sliderSettings}>
          {cards.map((card, index) => (
            <Card key={index}>
              ...
              <PrimaryButton as={Link} to={buttonUrl}>
                {buttonText}
              </PrimaryButton>
            </Card>
          ))}
