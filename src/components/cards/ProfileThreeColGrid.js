      ...
      <ContentWithPaddingXl>
        ...
        <Cards>
          {cards.map((card, index) => (
            <Card>
              <CardImage imageSrc="https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&fit=facearea&facepad=2.95&w=512&h=512&q=80" />
              <CardText>
                <CardHeader>
